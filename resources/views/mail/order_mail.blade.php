...
<p><strong>Bonjour Monsieur/Madame, </strong><br/><strong>Votre demande est confirmée avec les données suivantes. </strong></p>
<h3>Nom : {{ $order['name'] }}</h3>
<h3>Email : {{ $order['email'] }}</h3>
<h3>Numéro de facture : {{ $order['invoice_no'] }}</h3>
<h3>Montant : {{ $order['amount'] }}</h3>
...
<p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 18px; line-height: 21px;"><strong style=""><span style="line-height: 14px;">À propos</span></strong></span></p>
</div>
</div>
...
<div class="bee-block bee-block-2 bee-text">
<div class="bee-text-content" style="line-height: 150%; font-size: 12px; font-family: inherit; color: #fafafa;">
<p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">Votre Rue 12, 34567 Ville</span></p>
...
<p style="font-size: 14px; line-height: 16px; text-align: center;"><span style="font-size: 12px; line-height: 14px;">2022 © Tous droits réservés</span></p>
</div>
</div>
</div>
</div>
