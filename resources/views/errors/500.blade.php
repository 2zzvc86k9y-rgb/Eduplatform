					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="p-4 card-body">
								...
								<h2 class="font-weight-bold display-4">Désolé, erreur inattendue</h2>
								<p>Il semble que vous soyez perdu !<br>Peut-être n'êtes-vous pas connecté à Internet !</p>
								<div class="mt-5">	
									<a href="javascript:history.back()" class="btn btn-lg btn-primary px-md-5 radius-30">Retour</a>
								</div>
							</div>
						</div>
						<div class="col-xl-7">
							<img src="https://cdn.searchenginejournal.com/wp-content/uploads/2019/03/shutterstock_1338315902.png" class="img-fluid" alt="Image d'erreur 500">
						</div>
					</div>
					<!--end row-->
				</div>
