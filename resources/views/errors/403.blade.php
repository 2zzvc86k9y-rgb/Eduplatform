						...
						<div class="row g-0">
							<div class="col col-xl-5">
								<div class="p-4">
									...
									<h2 class="font-weight-bold display-4">Utilisateur sans permission</h2>
							...
							<div class="col-xl-7">
								<img src="https://cdn.searchenginejournal.com/wp-content/uploads/2019/03/shutterstock_1338315902.png" class="img-fluid" alt="Image d'erreur 403">
							</div>
						</div>
						<!--end row-->
					</div>
