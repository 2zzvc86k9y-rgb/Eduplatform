    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0"><i class="bx bx-globe me-2"></i>Site web</h6>
                                    <span class="text-secondary">{{ $profileData->website ?? 'Non défini' }}</span>
                                </li>
                                <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                                    <h6 class="mb-0"><i class="bx bxl-github me-2"></i>GitHub</h6>
                                    <span class="text-secondary">{{ $profileData->github ?? 'Non défini' }}</span>
                                </li>
                                <li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
                ...
                <div class="col-lg-8">
                    <div class="card shadow-sm">
                        <form id="passwordForm" action="{{ route('instructor.password.update') }}" method="POST" enctype="multipart/form-data" role="form" aria-label="Formulaire de changement de mot de passe">
                            @csrf
                            <div class="card-body">
                                <div class="mb-3 row">
                                    <div class="col-sm-3">
