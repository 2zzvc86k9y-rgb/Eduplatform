...
<section class="feature-area pb-90px" style="background: #fdf1e3;">
    <!-- Conteneur principal pour les boîtes d'information -->
    <div class="container">
        <div class="row feature-content-wrap">
            <!-- Première boîte : enseignants -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box modern-feature-card">
                    <!-- Superposition pour l'effet visuel -->
                    <div class="info-overlay"></div>
                    <!-- Icône centrée avec ombre -->
                    ...
                    <!-- Titre de la boîte -->
                    <h3 class="info__title">Enseignants experts</h3>
                    <!-- Description de la fonctionnalité -->
                    <p class="info__text">Nos enseignants qualifiés partagent leur expertise pour offrir des cours de qualité adaptés à tous les niveaux.</p>
                </div><!-- Fin de la boîte -->
            </div><!-- Fin de la colonne -->
            <!-- Deuxième boîte : communication -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box modern-feature-card">
                    <!-- Superposition pour l'effet visuel -->
                    <div class="info-overlay"></div>
                    ...
                    <!-- Titre de la boîte -->
                    <h3 class="info__title">Communication facile</h3>
                    <!-- Description de la fonctionnalité -->
                    <p class="info__text">Interagissez avec vos enseignants et collègues via des outils intégrés pour une collaboration fluide.</p>
                </div><!-- Fin de la boîte -->
            </div><!-- Fin de la colonne -->
            <!-- Troisième boîte : certificats -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box modern-feature-card">
                    <!-- Superposition pour l'effet visuel -->
                    <div class="info-overlay"></div>
                    ...
                    <!-- Titre de la boîte -->
                    <h3 class="info__title">Obtenez des certificats</h3>
                    <!-- Description de la fonctionnalité -->
                    <p class="info__text">Validez vos compétences avec des certificats reconnus à la fin de chaque cours réussi.</p>
                </div><!-- Fin de la boîte -->
            </div><!-- Fin de la colonne -->
...
.feature-area .modern-feature-card,
.feature-area .modern-feature-card:hover {
    color: #233d63;
}
.feature-area .modern-feature-card .info__title,
.feature-area .modern-feature-card .info__text,
.feature-area .modern-feature-card:hover .info__title,
.feature-area .modern-feature-card:hover .info__text {
    color: #233d63;
}
.feature-area .modern-feature-card {
    border-radius: 20px;
...
.feature-area .svg-icon-color-1 {
    color: #3578e5;
    fill: #3578e5;
}
.feature-area .svg-icon-color-2 {
    color: #43e97b;
    fill: #43e97b;
}
.feature-area .svg-icon-color-3 {
    color: #f7971e;
    fill: #f7971e;
}
.feature-area .info__title {
    font-size: 1.25rem;
    font-weight: 700;
    color: #233d63;
    margin-top: 8px;
