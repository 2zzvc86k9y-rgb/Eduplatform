<section class="overflow-hidden text-center client-logo-area section-padding position-relative">
    ...
    <div class="container">
        <div class="section-heading">
            <h5 class="mb-2 ribbon ribbon-lg">Nos partenaires</h5>
            <h2 class="section__title">Les meilleures entreprises choisissent <a href="for-business.html"
                    class="text-color hover-underline">EduPlatform</a> pour développer
                <br> des compétences professionnelles recherchées
            </h2>
