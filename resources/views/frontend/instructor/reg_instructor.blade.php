...
@section('title')
Devenir un Instructeur | EduPlatform
@endsection
...
<section class="feature-area section--padding bg-gray">
    <div class="container">
        <div class="text-center feature-heading-content-wrap">
            <div class="section-heading">
                <h2 class="section__title">Créez un cours vidéo en ligne <br>
                    et gagnez de l'argent en enseignant</h2>
        ...
        <div class="row pt-60px">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box before-none">
                    ...
                    <h3 class="info__title">01. Planifiez votre cours</h3>
                    <p class="info__text">Que vous souhaitiez évoluer en tant que professionnel ou découvrir un nouveau passe-temps, il existe un cours en ligne pour cela.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box before-none">
                    ...
                    <h3 class="info__title">02. Enregistrez votre vidéo</h3>
                    <p class="info__text">Que vous souhaitiez évoluer en tant que professionnel ou découvrir un nouveau passe-temps, il existe un cours en ligne pour cela.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box before-none">
                    ...
                    <h3 class="info__title">03. Construisez une communauté</h3>
                    <p class="info__text">Que vous souhaitiez évoluer en tant que professionnel ou découvrir un nouveau passe-temps, il existe un cours en ligne pour cela.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
        ...
        <div class="row">
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">instructeurs experts</p>
            ...
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <h4 class="counter__title counter text-color-3">54252</h4>
                    <p class="counter__meta">abonnés étrangers</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <h4 class="counter__title counter text-color-4">97220</h4>
                    <p class="counter__meta">étudiants inscrits</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column-half">
                <div class="counter-item">
                    ...
                    <p class="counter__meta">années d'expérience</p>
                </div><!-- end counter-item -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<section class="overflow-hidden register-area section--padding dot-bg">
    <div class="container">
        <div class="text-center register-heading-content-wrap">
            <div class="section-heading">
                <h2 class="section__title">Remplissez ce formulaire pour nous rejoindre</h2>
            </div><!-- end section-heading -->
        </div>
        <div class="row pt-50px">
            <div class="mx-auto col-lg-10">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="POST" action="{{ route('instructor.registration') }}" class="row">
                            @csrf

                            <div class="input-box col-lg-6">
                                <label class="label-text">Nom</label>
                                <div class="form-group">
                                    <input class="form-control form--control  @error('name') is-invalid @enderror " type="text" name="name" placeholder="ex. Alex">
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control  @error('email') is-invalid @enderror" type="email" name="email" placeholder="ex. alexsmith@gmail.com">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('address') is-invalid @enderror" type="text" name="address28107" placeholder="ex. 12345 Little Baker St, Melbourne">
                            ...
                            <div class="btn-box col-lg-12">
                                <div class="mb-4 custom-control custom-checkbox fs-15">
                                    ...
                                    <label class="custom-control-label custom--control-label" for="agreeCheckbox">en m'inscrivant, j'accepte les
                                        <a href="terms-and-conditions.html" class="text-color hover-underline">termes et conditions</a> et la
                                        <a href="privacy-policy.html" class="text-color hover-underline">politique de confidentialité</a>
                                    </label>
                                </div><!-- end custom-control -->
                                <button class="btn theme-btn" type="submit">Postuler maintenant <i class="ml-1 la la-arrow-right icon"></i></button>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
