...
<section class="dashboard-area">
    ...
    <div class="dashboard-content-wrap">
        <div class="mb-4 ml-3 dashboard-menu-toggler btn theme-btn theme-btn-sm lh-28 theme-btn-transparent">
            <i class="mr-1 la la-bars"></i> Navigation du tableau de bord
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="text-center modal-body">
                ...
                <h4 class="pt-2 pb-1 modal-title fs-19 font-weight-semi-bold" id="deleteModalTitle">Votre compte sera supprimé définitivement !</h4>
                <p>Êtes-vous sûr de vouloir supprimer votre compte ?</p>
                <div class="pt-4 btn-box">
                    <button type="button" class="mr-3 btn font-weight-medium" data-dismiss="modal">Annuler</button>
                    <button type="submit" class="btn theme-btn theme-btn-sm lh-30">OK, Supprimer</button>
                </div>
            </div><!-- end modal-body -->
