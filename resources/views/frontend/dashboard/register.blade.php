        ...
        <div class="container">
            <div class="flex-wrap breadcrumb-content d-flex align-items-center justify-content-between">
                <div class="section-heading">
                    <h2 class="text-white section__title">Inscription</h2>
                </div>
            ...
            <div class="row">
                <div class="mx-auto col-lg-7">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="pb-4 text-center card-title fs-24 lh-35">Créez un compte et <br> commencez à apprendre !</h3>
                            <div class="section-block"></div>

                            <form method="POST" class="pt-4 shadow-sm" action="{{ route('register') }}">
                                @csrf
                                ...
                                <div class="pt-3 pb-4 text-center">
                                    <div class="shadow-sm icon-element icon-element-md fs-25">Ou</div>
                                </div>
                                <div class="input-box">
                                    <label class="label-text">Nom complet</label>
                                    <div class="form-group">
                                        <input class="form-control form--control" id="name" type="text" name="name"
                                            placeholder="Votre nom complet" value="{{ old('name') }}" required autofocus>
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form--control" id="username" type="text" name="username"
                                ...
                                <div class="input-box">
                                    <label class="label-text">Confirmer le mot de passe</label>
                                    <div class="mb-3 input-group">
                                        <span class="la la-lock input-icon"></span>
                                        <input class="form-control form--control password-field" type="password"
                                ...
                                <div class="btn-box">
                                    <div class="mb-2 custom-control custom-checkbox fs-15">
                                        <input type="checkbox" class="custom-control-input" id="receiveCheckbox" name="receive_emails">
                                        <label class="custom-control-label custom--control-label lh-20" for="receiveCheckbox">
                                            Oui ! Je souhaite profiter au maximum d'EduPlatform en recevant des emails avec des offres exclusives, des recommandations personnalisées et des astuces d'apprentissage !
                                        </label>
                                    ...
                                    <div class="mb-4 custom-control custom-checkbox fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="agreeCheckbox">
                                            ...
                                            <a href="#" class="text-color hover-underline">conditions générales</a> et la
                                            <a href="#" class="text-color hover-underline">politique de confidentialité</a>
                                        </label>
                                    </div><!-- end custom-control -->
                                    <button class="btn theme-btn" type="submit">Créer un compte <i class="ml-1 la la-arrow-right icon"></i></button>
                                    <p class="pt-2 fs-14">Vous avez déjà un compte ? <a href="{{ route('login') }}" class="text-color hover-underline">Se connecter</a></p>
                                </div><!-- end btn-box -->
                            </form>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
