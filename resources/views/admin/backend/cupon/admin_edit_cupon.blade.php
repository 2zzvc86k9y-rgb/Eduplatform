        ...
        <div class="ps-3">
            <nav aria-label="Fil d'Ariane">
                <ol class="p-0 mb-0 breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Modifier un coupon</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="mx-auto col-xl-10">
            <div class="card shadow-sm">
                <div class="p-4 card-body">
                    <h5 class="mb-4">Modifier un coupon</h5>
                    <form id="myForm" action="{{ route('admin.update.cupon') }}" method="POST" class="row g-3">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('cupon_name') is-invalid @enderror" id="cupon_name" name="cupon_name"
                                value="{{ old('cupon_name', $cupon->cupon_name) }}" required aria-describedby="cupon_name_error">
                            @error('cupon_name')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control @error('cupon_discount') is-invalid @enderror" id="cupon_discount" name="cupon_discount"
                                    value="{{ old('cupon_discount', $cupon->cupon_discount) }}" min="0" max="100" step="1" required aria-describedby="cupon_discount_error">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control @error('cupon_validity') is-invalid @enderror" id="cupon_validity" name="cupon_validity"
                                min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" value="{{ old('cupon_validity', $cupon->cupon_validity) }}"
                        ...
                        <div class="col-md-12">
                            <div class="gap-3 d-md-flex d-grid align-items-center">
                                <button type="submit" class="px-4 btn btn-primary" aria-label="Mettre à jour le coupon">Mettre à jour</button>
                            </div>
                        </div>
                    </form>
                </div>
