                    ...
                    <form id="myForm" action="{{ route('store.category') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('category_name') is-invalid @enderror" id="input1" name="category_name"
                                value="{{ old('category_name') }}" placeholder="Entrez le nom de la catégorie" required>
                            @error('category_name')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('photo') is-invalid @enderror" type="file" id="image" name="photo" accept="image/*" required>
                            @error('photo')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="gap-3 d-md-flex d-grid align-items-center">
                                <button type="submit" class="px-4 btn btn-primary" aria-label="Ajouter la catégorie">Ajouter</button>
                            </div>
                        </div>
                    </form>
                </div>
