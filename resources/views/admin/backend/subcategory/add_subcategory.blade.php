                    ...
                    <form id="myForm" action="{{ route('store.subcategory') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('subcategory_name') is-invalid @enderror" id="subcategory_name" name="subcategory_name"
                                value="{{ old('subcategory_name') }}" placeholder="Entrez le nom de la sous-catégorie" required>
                        ...
                        <div class="col-md-12">
                            <div class="gap-3 d-md-flex d-grid align-items-center">
                                <button type="submit" class="px-4 btn btn-primary" aria-label="Ajouter la sous-catégorie">Ajouter</button>
                            </div>
                        </div>
                    </form>
                </div>
